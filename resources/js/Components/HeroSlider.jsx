...
export default function HeroSlider() {
    ...
    const slides = [
        {
            ...
            imageUrl: '/images/hero-1.jpg', // Replace with your actual image path
            bgColor: 'bg-pink-500',
            song: {
                title: 'Lazy Soul',
        ...
        },
        {
            ...
            imageUrl: '/images/hero-2.jpg', // Replace with your actual image path
    ...
    return (
        <div className="relative min-h-screen">
            ...
            >
                {slides.map((slide) => (
                    <SwiperSlide key={slide.id} className={`${slide.bgColor}`}>
                        <div
                        ...
                        <div className="container relative z-10 mx-auto flex h-screen flex-col justify-center px-4">
                            <div className="max-w-3xl">
                                ...
                                <div className="flex space-x-4">
                                    <button className="flex items-center rounded-full bg-pink-500 px-6 py-2 font-semibold text-white hover:bg-pink-600">
                                        <span className="mr-2">
                                            <svg
            ...
            {/* Pagination dots */}
            <div className="swiper-pagination absolute bottom-8 z-20 w-full"></div>
            ...
            <div className="fixed bottom-0 left-0 right-0 z-50 bg-white">
                <div className="container mx-auto flex items-center p-2">
                    <div className="flex items-center">
                        ...
                        />
                        <div>
                            <div className="font-semibold">Lazy Soul</div>
                    ...
                    <div className="ml-6 flex-grow">
                        <AudioPlayer audioSrc="/audio/lazy-soul.mp3" />
                    </div>
                </div>
            </div>
        </div>
